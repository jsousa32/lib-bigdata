package io.github.jsousa32.lib_bigdata.companies.entities.owners_lawsuits_distribution_data;

import java.util.HashMap;
import java.util.Map;
import java.util.Objects;

public class OwnersLawsuitsDistributionData {

    private String taxIdNumber;

    private int totalOwners;

    private int maxLawsuitsPerOwner;

    private double avgLawsuitsPerOwner;

    private int minLawsuitsPerOwner;
    ...
    public int getMaxLawsuitsPerOwner() {
        return maxLawsuitsPerOwner;
    }

    public double getAvgLawsuitsPerOwner() {
        return avgLawsuitsPerOwner;
    }

    public int getMinLawsuitsPerOwner() {
        return minLawsuitsPerOwner;
    }
